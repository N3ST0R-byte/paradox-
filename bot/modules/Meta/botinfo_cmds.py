...
async def cmd_about(ctx):
    ...
    links = "[Support Server]({sprt}), [Invite Me]({invite}), [Help keep me running!]({donate})".format(sprt=ctx.bot.objects["support_guild"],
    ...
    fields = ["Developers", "Servers", "Members", "Commands", "Memory", "CPU Usage", "API version", "Python version", "Platform"]
